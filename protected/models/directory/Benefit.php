 ...
 * @property integer $isPV
 * @property integer $isPZK
...
class Benefit extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idBenefit, BenefitGroupID, isPV, isPZK, Visible', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
                    ...
                    'isPV'=>'Пільга на позачерговий вступ',
                    'isPZK'=>'Пільга на позаконкурсний вступ',
	...
	public function search()
	{
		...
		$criteria->compare('isPV',$this->isPV);
		$criteria->compare('isPZK',$this->isPZK);
