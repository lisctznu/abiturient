...
class Personeducationforms extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'personspecialities' => array(self::HAS_MANY, 'Personspeciality', 'EducationFormID'),
		);
	}
	...
	{
		return array(
    'idPersonEducationForm' => 'idPersonEducationForm',
    'PersonEducationFormName' => 'PersonEducationFormName',
		);
	}
